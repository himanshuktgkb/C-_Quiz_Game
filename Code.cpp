...
void info()
{
	...
	cout << " \\_ | Select==>                            |." << endl;
	gotoXY(38, 10);
	cout << "    | Press only Valid Option--> (a,b,c,d)  |." << endl;
	gotoXY(38, 11);
...
void quiz()
{
	...
	abc[4] = {"Which of the following keywords cann`t appear inside a class definition?", "template", "static", "virtual", "friend", 'a'};
